...
class AdminDefaultHeader extends Component {
  render() {
      ...
      <React.Fragment>
        ...
        <Nav className="ml-auto" navbar>
          ...
          <UncontrolledDropdown nav direction="down">
            <DropdownToggle nav>
              <img src={'../../assets/img/avatars/vcti.jpg'} className="img-avatar" alt="User" />
            </DropdownToggle>
            <DropdownMenu right>
...
AdminDefaultHeader.propTypes = propTypes;
AdminDefaultHeader.defaultProps = defaultProps;
