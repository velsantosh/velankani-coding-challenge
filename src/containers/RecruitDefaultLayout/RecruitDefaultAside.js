...
class RecruitDefaultAside extends Component {
...
RecruitDefaultAside.propTypes = propTypes;
RecruitDefaultAside.defaultProps = defaultProps;

export default RecruitDefaultAside;
