...
class ScheduledChallengeDataService {
    ...
    runScheduledQuestionTestCases(validateProgramContent) {
        ...
        return axios.post(`http://localhost:8082/runSubjQuesTestCode`, validateProgramContent, {
            headers: {
                'Content-Type': 'application/json', 'Access-Control-Allow-Origin': '*'
            },
            crossdomain: true
    ...
    getScheduledQuestionByCandidateId(candidateId) {
        ...
        return axios.get(`http://localhost:8083/schQuesByCandidate/?userId=${candidateId}`,
            {
                headers: {
                    'Content-Type': 'application/json', 'Access-Control-Allow-Origin': '*'
                },
    ...
    updateChallengeStatus(candidateId) {
        ...
        return axios.put(`http://localhost:8083/updateChallengeStatus/?candidateId=${candidateId}`,
            {
                headers: {
                    'Content-Type': 'application/json', 'Access-Control-Allow-Origin': '*'
                },
    ...
    getAllVideoStreamingCandidateData(assigneruid) {
        ...
        return axios.get(`http://localhost:8083/schedule/videostream/${assigneruid}`,
            {
                headers: {
                    'Content-Type': 'application/json', 'Access-Control-Allow-Origin': '*'
                },
