...
class UsersDataService {
    ...
    getAllCandidates(userName) {
        return axios.get(`http://localhost:8083/candidateReport/?candidateId=${userName}`,
            {
                headers: {
    ...
    download(userId, challengeid) {
        return axios.get(`http://localhost:8083/subjResReport/${userId}/${challengeid}`,
            {
                headers: {
                    'Access-Control-Allow-Origin': '*',
                }, responseType: 'blob',
    ...
    getAllRequests() {
        return axios.get(`http://localhost:8083/schedule/request`, {
            headers: {
                'Access-Control-Allow-Origin': '*',
            },
        })
    ...
    getInterviewer() {
        ...
        return axios.get(`http://localhost:8081/usersByRole/INTERVIEWER`, {
            headers: {
                'Access-Control-Allow-Origin': '*',
            },
        });
