...
class QuestionService {
    ...
    addQuestion(question) {
        ...
        return axios.post(`http://vcct.blr.velankani.com:8082/subQuestion`, question, {
            headers: {
    ...
    addObjQuestion(question) {
        ...
        return axios.post(`http://vcct.blr.velankani.com:8082/question`, question);
    }
    ...
    getQuestions() {
        ...
        return axios.get(`http://vcct.blr.velankani.com:8082/questions`);
    }
    ...
    addSubjectiveQuestion(subjectiveQuestionData) {
        ...
        return axios.post('http://vcct.blr.velankani.com:8082/add/sub/question', subjectiveQuestionData);
    }
    addObjectiveQuestion(objectiveQuestionData) {
        ...
        return axios.post('http://vcct.blr.velankani.com:8082/add/obj/question', objectiveQuestionData);
    }
    modifySubjectiveQuestion(qId, questionData) {
        ...
        return axios.put(`http://vcct.blr.velankani.com:8082/update/sub/question/${qId}`, questionData);
    }
    modifyObjectiveQuestion(qId, questionData) {
        ...
        return axios.put(`http://vcct.blr.velankani.com:8082/update/obj/question/${qId}`, questionData);
    }
    getQuestionsByTech(tech) {
        ...
        return axios.get(`http://vcct.blr.velankani.com:8082/questions/tech/${tech}`);
    }
    ...
    getQuestionsById(id) {
        ...
        return axios.get(`http://vcct.blr.velankani.com:8082/question/${id}`);
    }
    ...
    getChlngRecByAssignerId(assignerId) {
        ...
        return axios.get(`http://vcct.blr.velankani.com:8083/chlngRecByassignerId/?assignerId=${assignerId}`,
            {
                headers: {
                    'Content-Type': 'application/json', 'access-control-allow-origin': '*'
                },
    ...
    deleteChallenge(challengeId) {
        //console.log('executed service')
        // return axios.get(`${apiBaseUrl}/questions`);
        // return axios.delete(`http://vcct.blr.velankani.com:8083/challenge/${challengeId}`,
        return axios.delete(`http://vcct.blr.velankani.com:8083/challenge/${challengeId}`);
    }
    ...
    getQuestionsByChallengeId(challengeId) {
        //console.log('executed service')
        // return axios.get(`${apiBaseUrl}/questions`);
        return axios.get(`http://vcct.blr.velankani.com:8083/schQuesBychallengeId/${challengeId}`);
    }

    getQuestionsNotByChallengeId(assigneduid, challengeId) {
        //console.log('executed service')
        // return axios.get(`${apiBaseUrl}/questions`);
        return axios.get(`http://vcct.blr.velankani.com:8083/schQuesNotBychallengeId/${assigneduid}/${challengeId}`);
    }

    assignUpdateQuestion(question) {
        // return axios.get(`${apiBaseUrl}/question`,question);
        return axios.put(`http://vcct.blr.velankani.com:8083/updateChallenge`, question);
    }
    ...
    createQuestionTemplate(questionTemplateData) {
        ...
        return axios.post(`http://vcct.blr.velankani.com:8082/add/questionTemplate`, questionTemplateData);
    }
    ...
    updateQuestionTemplate(questionTemplateData, templateId) {
        ...
        return axios.put(`http://vcct.blr.velankani.com:8082/update/questionTemplate/${templateId}`, questionTemplateData);
    }
    ...
    getAllQuestionsDataByTemplateId(templateId) {
        ...
        return axios.get(`http://vcct.blr.velankani.com:8082/getAllQuestionsDataByTemplateId/${templateId}`, templateId);
    ...
    getAllQuestionTemplates() {
        ...
        return axios.get(`http://vcct.blr.velankani.com:8082/getAllQuestionsTemplates`);
    ...
    getAllQuestionsByTechDiffiExp(technology, difficulty, experience) {
        ...
        return axios.get(`http://vcct.blr.velankani.com:8082/questions/${technology}/${difficulty}/${experience}`);
    ...
    getAllQuestTempByTechDiffiExp(technology, difficulty, experience) {
        ...
        return axios.get(`http://vcct.blr.velankani.com:8082/getFilteredTemplates/${technology}/${difficulty}/${experience}`);
    ...
    assignQuestionsByTemplate(QuestionSchedulerData) {
        ...
        return axios.post(`http://vcct.blr.velankani.com:8083/assignTemplates`, QuestionSchedulerData);
    ...
    deleteQuestionTemplate(questTemplateId) {
        ...
        return axios.delete(`http://vcct.blr.velankani.com:8082/delete/questionTemplate/${questTemplateId}`);
    }

    uploadSubjFile(question) {
        // return axios.get(`${apiBaseUrl}/question`,question);
        // return axios.post(`http://vcti.com:8765/cctservice/uploadSubjFile`, question,
        return axios.post(`http://vcct.blr.velankani.com:8082/uploadSubjFile`, question,
            {
                headers: {
    ...
    uploadObjFile(question) {
        ...
        return axios.post(`http://vcct.blr.velankani.com:8082/uploadObjFile`, question,
            {
                headers: {
                    'Content-Type': `multipart/form-data`,
                }
    ...
    deleteQuestiob(qId) {
        ...
        return axios.delete(`http://vcct.blr.velankani.com:8082/question/${qId}`);
    }
