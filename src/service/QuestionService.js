...
class QuestionService {
    ...
    assignObjQuestion(question) {
        // return axios.get(`${apiBaseUrl}/question`,question);
        return axios.post(`http://vcti.com:8765/srvservice/bulkAssignUser`, question);
    }
    ...
    deleteChallenge(challengeId) {
        //console.log('executed service')
        // return axios.get(`${apiBaseUrl}/questions`);
        return axios.delete(`http://vcti.com:8765/srvservice/challenge/${challengeId}`);
    }

    getQuestionsByChallengeId(challengeId) {
        //console.log('executed service')
        // return axios.get(`${apiBaseUrl}/questions`);
        return axios.get(`http://vcti.com:8765/srvservice/schQuesBychallengeId/${challengeId}`);
    }

    getQuestionsNotByChallengeId(assigneduid, challengeId) {
        //console.log('executed service')
        // return axios.get(`${apiBaseUrl}/questions`);
        return axios.get(`http://vcti.com:8765/srvservice/schQuesNotBychallengeId/${assigneduid}/${challengeId}`);
    }

    assignUpdateQuestion(question) {
        // return axios.get(`${apiBaseUrl}/question`,question);
        return axios.put(`http://vcti.com:8765/srvservice/updateChallenge`, question);
    }
    ...
    assignQuestionsByTemplate(QuestionSchedulerData) {
        ...
        return axios.post(`http://vcti.com:8765/srvservice/assignTemplates`, QuestionSchedulerData);
